...
namespace DeskBooker.Core.Processor
{
    public class DeskBookingRequestProcessorTests
    {
        ...
        public void ShouldReturnExpectedResultCode(DeskBookingResultCode expectedResultCode, bool isDeskAvaible)
        {
            if (! isDeskAvaible)
            {
                _availableDesks.Clear();
        ...
        public void ShouldReturnExpectedDeskBookingId(int? expectedDeskBookingId, bool isDeskAvaible)
        {
            if (!isDeskAvaible)
            {
                _availableDesks.Clear();
            ...
            {
                _deskBookingRepositoryMock.Setup(x => x.Save(It.IsAny<DeskBooking>())).Callback<DeskBooking>(
                    deskBooking =>
                    {
